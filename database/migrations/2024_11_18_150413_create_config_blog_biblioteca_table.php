...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('config_blog_biblioteca', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('tipo', ['articulo', 'libro']); // Columna 'tipo' para el tipo de anuncio
    ...
    {
        Schema::dropIfExists('config_blog_biblioteca');
    }
};
